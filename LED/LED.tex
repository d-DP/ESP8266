...
\end{lstlisting}
\textbf{Install ESP8266 2.3.0 Version}
\begin{lstlisting}
#Open Boards Manager from Tools
#Install ESP8266 2.3.0 version
...
\begin{enumerate}
\item Make the connections according to TABLE II and TABLE III
\begin{table}[!h]
\centering
...
\item Execute the below code for LED Blink
\begin{lstlisting}
https://github.com/d-DP/ESP8266/blob/master/codes/WiFiBlink/blink1/blink1.ino
\end{lstlisting}
\item Open the serial monitor to get IP address and enter that IP address in browser
\item Connect GPIO to LED Cathode by disconnecting from GND
\end{enumerate}
\end{document}
